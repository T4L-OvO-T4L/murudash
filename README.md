...
## 🎮 ゲームについて
「むるだっしゅ！」はブラウザ上で遊べる簡単なジャンプアクションゲームです。  
ジャンプボタンでひまわりやブルーベリーをよけまくろう！
...
## 📜 ライセンス
このゲームのソースコードは [MIT License](https://opensource.org/licenses/MIT) に基づいて公開されています。  
ただし、各素材の著作権はそれぞれの作者に帰属します。  
再配布・改変の際は各ライセンス条件を遵守してください。
